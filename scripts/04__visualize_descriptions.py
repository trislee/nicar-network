...
OUTPUT_JSON = "../public/descriptions.json"
...
CLUSTERS = [
    ...
    {"key": "1", "clusterLabel": "Documents"},
    {"key": "2", "clusterLabel": "Git"},
    {"key": "3", "clusterLabel": "Python & AI"},
    {"key": "4", "clusterLabel": "Investigation topics"},
    {"key": "5", "clusterLabel": "R & Cleaning"},
    {"key": "6", "clusterLabel": "SQL"},
    {"key": "7", "clusterLabel": "Web dev"},
    {"key": "8", "clusterLabel": "Social media"},
    {"key": "9", "clusterLabel": "Maps & geospatial"},
    {"key": "10", "clusterLabel": "Excel & spreadsheets"}
]
...
if __name__ == "__main__":
    ...
    edges = [[label_to_index[e["source"]], label_to_index[e["target"]], e["weight"] / EDGE_SCALING] for e in edges_df.to_dict(orient="records")]
